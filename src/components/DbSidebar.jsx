...
function DbSidebar() {
  ...
  return (
    <div class="absolute left-0 top-0 z-[9999] flex h-screen w-[270px] flex-col overflow-y-hidden text-white bg-secondary duration-300 ease-linear lg:static transition-all lg:translate-x-0">
      <div class="flex items-center justify-between gap-2 py-5.5 lg:py-6.5">
        <Link to="/" class="block w-full">
          <div class="py-[1rem] border-b border-b-gray-300 px-6 w-full flex items-center space-x-3">
        ...
        <div class="py-4 px-3">
          ...
          <nav class="">
            <div class="flex flex-col h-auto overflow-y-auto scroll pb-12">
              <div>
                <div class="w-full rounded-[4px] transition-all duration-150 mb-3 hover:bg-primary">
                  <Link
                    to="/admin/dashboard"
      ...
      <div class="w-full px-3 font-roboto transition-all duration-150 absolute left-0 bottom-2 bg-secondary">
        <a class="font-bold text-md rounded-[4px] flex h-[48px] items-center cursor-pointer mb-1 pl-3 bg-[#BE1700]">
          <svg
            width="22"
            height="22"
            viewBox="0 0 22 22"
