...
function Footer() {
  return (
    <div className="bg-secondary xl:px-32 sm:px-5 px-2 grid gap-y-10 xl:grid-cols-5 gap-4 md:grid-cols-3 py-20 text-white">
      <div>
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-4">
          <Link to="/ProductDetail/1">
            <div className="flex gap-4 items-center">
              <div className="w-[80px] h-[80px] shrink-0 rounded-md overflow-hidden">
                <img
      ...
      <div className="xl:col-span-2 md:col-span-3">
        <div className="bg-[#383E52] flex flex-col items-center p-10 rounded-xl">
          ...
          <div className="xl:w-full md:w-[50%] w-full h-[55px] bg-white rounded-full">
            <input
          ...
          <button className="xl:w-full md:w-[50%] w-full h-full bg-primary rounded-full py-4 font-bold mt-3">
            Subscribe
          </button>
        </div>
      </div>
